...
int TestDirect3d(uint test_type)
{
    ...
    switch(test_type)
    {
        case 0:
        {
            ...
            int cposx = (int)(400+cc*100), 
				cposy = (int)(300-cs*100);

            cc*=100.0f; cs*=100.0f;

            pvec[0].Set((uint16)(cposx+cc), (uint16)(cposy+cs), D3DCOLOR_ARGB(0xff, icc, 0xff-icc, 0));
            pvec[1].Set((uint16)(cposx-cc), (uint16)(cposy-cs), D3DCOLOR_ARGB(0xff, icc, icc, 0xff-icc));
            pvec[2].Set((uint16)(cposx+cs), (uint16)(cposy+cc), D3DCOLOR_ARGB(0xff, ics, ics, 0xff-ics));
            pvec[3].Set((uint16)(cposx-cs), (uint16)(cposy-cc), D3DCOLOR_ARGB(0xff, ics, 0xff-ics, 0));
            pvec[4].Set((uint16)(cposx+cc), (uint16)(cposy+cs), D3DCOLOR_ARGB(0xff, icc, 0xff-icc, 0));
